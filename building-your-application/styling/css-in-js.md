...
* [`styled-jsx`](css-in-js.md#styled-jsx)
* [`styled-components`](css-in-js.md#styled-components)
...
If you want to style Server Components, we recommend using [CSS Modules](https://nextjs.org/docs/app/building-your-application/styling/css) or other solutions that output CSS files, like PostCSS or [Tailwind CSS](https://nextjs.org/docs/app/building-your-application/styling/tailwind-css).
