...
* [Safari 15 - 16.3](https://bugs.webkit.org/show_bug.cgi?id=243601) display a gray border while loading. Safari 16.4 [fixed this issue](https://webkit.org/blog/13966/webkit-features-in-safari-16-4/). Possible solutions:
...
| `v12.0.0`  | <p><code>formats</code> configuration added.<br>AVIF support added.<br>Wrapper <code>&#x3C;div></code> changed to <code>&#x3C;span></code>.</p>                                                                                                                                                                                                                                                                          |
| `v11.1.0`  | `onLoadingComplete` and `lazyBoundary` props added.                                                                                                                                                                                                                                                                                                                                                                      |
| `v11.0.0`  | <p><code>src</code> prop support for static import.<br><code>placeholder</code> prop added.<br><code>blurDataURL</code> prop added.</p>                                                                                                                                                                                                                                                                                  |
