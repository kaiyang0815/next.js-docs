...
{% content-ref url="../../../app-router/api-reference/file-conventions/metadata-files/manifest.json.md" %}
[manifest.json.md](../../../app-router/api-reference/file-conventions/metadata-files/manifest.json.md)
{% endcontent-ref %}
